...
//     if (isTransitioning) {
//       if (isCurrent) return 'translate-x-full'; // Slide current right
//       if (isPrevious) return '-translate-x-full'; // Slide previous left
//     } else {
//       if (isCurrent) return 'translate-x-0'; // Center current
//       if (isPrevious) return '-translate-x-full'; // Hide previous left
//     }
//     return 'translate-x-full'; // Hide others right
//   };
...
//             className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg shadow-md transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
//           >
//             {isFetchingMore ? (
//               <>
